...
AliasMatch ^/manual(?:/(?:da|de|en|es|fr|ja|ko|pt-br|ru|tr|zh-cn))?(/.*)?$ "/tmp/pip-install-p_mataao/mod-wsgi-httpd/build/httpd/manual$1"

<Directory "/tmp/pip-install-p_mataao/mod-wsgi-httpd/build/httpd/manual">
    Options Indexes
    AllowOverride None
    Require all granted
